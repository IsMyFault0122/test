...
def get_args_parser():
    ...
    parser.add_argument('--ratio_training', default=0.8, type=float,
                        help="The ration of training data")
    parser.add_argument('--data_path', default='./Rice_UAV_dataset', type=str,
...
def points_from_json(json_file):
    ...
    for points in shpae_file:
        point_1 = points["points"][0]
        point_2 = points["points"][1]
        point_x = 0.5*(point_1[0]+point_2[0])
        point_y = 0.5*(point_1[1]+point_2[1])
        #print(point_x)
        #print(point_y)
