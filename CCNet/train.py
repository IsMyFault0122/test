...
from .crop_datasets import build_dataset
from .engine import *
...
def get_args_parser():
    parser = argparse.ArgumentParser('Set parameters for training CCNet', add_help=False)
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='CCP')
...
def main(args):
    ...
    data_loader_train = DataLoader(train_set, batch_sampler=batch_sampler_train,
                                   collate_fn=misc.collate_fn_crowd, num_workers=args.num_workers)

    data_loader_val = DataLoader(val_set, 1, sampler=sampler_val,
                                    drop_last=False, collate_fn=misc.collate_fn_crowd, num_workers=args.num_workers)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('CCNet training and evaluation script', parents=[get_args_parser()])
